  ...
  <h2>{{title}}</h2>
    ...
    <div class="two-columns">
        ...
        <div class="title title-container">Eventos</div>
          <div class="first">
            <div class="img-container">
              <div class="text"><a href="/#/event4">IIeX Latam 2018</a><br>30/01/2019 - 14:00</div>
            </div>
          </div>
          <div class="second">
          ...
          <div class="item-2">
            <div class="img-container">
              <div class="text"><a href="/#/event5">Exhibición “Matta. Obra Gráfica"</a><br>31/01/2019 - 10:00</div>
            </div>
          </div>
        </div>
      ...
      <div class="news">
        ...
        <div class="item-1">
          <div class="img-container">
            <div class="text"><a href="/#/news3">Licaf va por el bicampeonato y Periodismo sueña con volver a primera</a></div>
          </div>
        </div>
        <div class="item-2">
          <div class="img-container">
            <div class="text"><a href="/#/news10">Investigan efectos de algas marinas para remover hidrocarburos del mar</a></div>
          </div>
        </div>
      </div>
